...
const GovernmentAuditorDashboard = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'Compliances': return <CompliancesView showCreateButton={false} />;
      case 'Audits': return <AuditsView />;
      case 'Reports': return <ReportsView />;
      default: return <CompliancesView showCreateButton={false} />;
    }
  };
      ...
      >
        <div className="p-6">
          <h2 className="text-white text-xl font-bold tracking-tight flex items-center">
            <span className="mr-2">⚖️</span> AgriGov Auditor
          </h2>
        </div>
